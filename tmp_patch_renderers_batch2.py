...
replacement = '''function renderGenerationFlow() {
...
'''
content, count = re.subn(r'function renderGenerationFlow\(\) \{[\s\S]*?\n\}', replacement, content, count=1)
if count != 1:
    raise SystemExit('failed to replace renderGenerationFlow')
path.write_text(content, encoding='utf-8')
print('patched generation flow')
